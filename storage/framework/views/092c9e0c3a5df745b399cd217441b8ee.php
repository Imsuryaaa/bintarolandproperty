<?php $__env->startSection('title', (isset($isHotsale) && $isHotsale ? 'Properti Hotsale Pilihan' : 'Semua Listing Properti') . ' – Bintaro Land Property'); ?>
<?php $__env->startSection('meta_description', isset($isHotsale) && $isHotsale ? 'Daftar properti hotsale pilihan terbaik dari Bintaro Land Property dengan harga menarik.' : 'Temukan semua properti terbaik di Bintaro dan sekitarnya. Rumah, kavling, ruko – dari terbaru hingga terlama. Bintaro Land Property.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u851258633/domains/bintarolandproperty.com/public_html/resources/views/properties/index.blade.php ENDPATH**/ ?>