    ...
    <div class="relative z-10 container-main pb-12 pt-20 lg:pb-16 lg:pt-24 w-full">
        <div class="max-w-2xl">
            ...
            <div class="mb-8" data-reveal data-reveal-delay="2">
                <a href="<?php echo e(route('about')); ?>" class="animated-btn-wrapper group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Gawe\website landing page\bintaro-propertyv2\resources\views/home.blade.php ENDPATH**/ ?>