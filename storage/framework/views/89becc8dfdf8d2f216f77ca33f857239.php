<?php $__env->startSection('title', 'Tentang Kami | Profil Bintaro Land Property'); ?>
<?php $__env->startSection('meta_description', 'Pelajari lebih lanjut tentang Bintaro Land Property, agen properti profesional dan terpercaya di Bintaro yang siap membantu mewujudkan hunian ideal Anda.'); ?>
...
<section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex items-center justify-center min-h-[40vh]">
    <div class="absolute inset-0">
        <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1800&q=80" alt="Tentang Bintaro Land Property" class="w-full h-full object-cover">
...
<section class="py-16 lg:py-24 bg-white dark:bg-charcoal-950">
    <div class="container-main">
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
            <div class="relative" data-aos="fade-right">
                <div class="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                    <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&q=80" alt="Tim Bintaro Land Property" class="w-full h-full object-cover">
                </div>
                <!-- Decorative element -->
        ...
        <div class="relative rounded-3xl overflow-hidden bg-brand-600 mb-24 shadow-xl" data-aos="zoom-in">
            <div class="absolute inset-0">
                <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=1200&q=80" alt="Interior Mewah" class="w-full h-full object-cover mix-blend-overlay opacity-40">
        ...
        <div class="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-7 order-1 lg:order-2" data-aos="fade-left">
                ...
                <div class="mt-10">
                    <a href="<?php echo e(route('home')); ?>#kontak" class="btn-primary px-8 py-3.5 text-base rounded-lg inline-flex items-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u851258633/domains/bintarolandproperty.com/public_html/resources/views/about.blade.php ENDPATH**/ ?>