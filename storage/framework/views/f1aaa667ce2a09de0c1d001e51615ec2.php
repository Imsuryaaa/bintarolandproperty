<?php $__env->startSection('title', isset($property) ? 'Edit Properti' : 'Tambah Properti'); ?>
<?php $__env->startSection('page-title', isset($property) ? 'Edit Properti' : 'Tambah Properti'); ?>
...
<div class="flex flex-col xl:flex-row gap-6 items-start">
    <div class="w-full xl:w-[65%] 2xl:w-2/3 max-w-4xl">
        <div class="mb-5">
            <a href="<?php echo e(route('admin.properties.index')); ?>" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">
    ...
    <form method="POST"
          action="<?php echo e(isset($property) ? route('admin.properties.update', $property) : route('admin.properties.store')); ?>"
          enctype="multipart/form-data"
          class="space-y-5"
          id="property-form"
          x-data="{
              propertyType: '<?php echo e(old('property_type', $property->property_type ?? 'rumah')); ?>',
              listingType: '<?php echo e(old('listing_type', $property->listing_type ?? 'dijual')); ?>',
              rentPeriod: '<?php echo e(old('rent_period', $property->rent_period ?? 'tahun')); ?>',
              priceType: '<?php echo e(old('price_type', $property->price_type ?? 'total')); ?>',
        ...
        <?php if(session('duplicate_error') && session('duplicate_property')): ?>
        <?php $dupProp = session('duplicate_property'); ?>
        <div class="p-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-sm text-red-700 dark:text-red-400 flex items-start gap-4">
            <?php if($dupProp->photos->isNotEmpty()): ?>
                <img src="<?php echo e($dupProp->photos->first()->url); ?>" alt="Cover" class="w-20 h-20 object-cover rounded-lg border border-red-200 dark:border-red-800">
            <?php endif; ?>
            <div>
                <p class="font-bold text-red-800 dark:text-red-300 mb-1">Kode Properti Sudah Terpakai!</p>
                <p class="mb-2">Kode <strong><?php echo e(old('property_code')); ?></strong> sudah digunakan oleh properti: <br><span class="font-semibold"><?php echo e($dupProp->title); ?></span></p>
                <a href="<?php echo e(route('admin.properties.edit', $dupProp)); ?>" target="_blank" class="inline-flex items-center gap-1 text-xs font-semibold bg-red-100 dark:bg-red-800 text-red-700 dark:text-red-100 px-3 py-1.5 rounded-md hover:bg-red-200 dark:hover:bg-red-700 transition-colors">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
            ...
            ?>
            <input type="hidden" name="property_condition" id="property_condition_input" value="<?php echo e($selectedCondition); ?>">
            ...
            <div class="flex flex-wrap gap-2 mb-5" id="property-type-selector">
                <?php $__currentLoopData = \App\Models\Property::TYPES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeKey => $typeDef): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button"
                        @click="propertyType = '<?php echo e($typeKey); ?>'"
                        :class="propertyType === '<?php echo e($typeKey); ?>' ? 'border-amber-500 bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400 shadow-sm' : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:border-gray-400 dark:hover:border-gray-500'"
                    ...
                    <span class="text-base leading-none"><?php echo e($typeDef['icon']); ?></span>
                    <span><?php echo e($typeDef['label']); ?></span>
                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="flex flex-wrap gap-2" id="property-condition-selector">
                <?php $__currentLoopData = \App\Models\Property::CONDITIONS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $condKey => $condDef): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button type="button"
                        class="cond-btn flex items-center gap-2 px-4 py-2.5 rounded-lg border-2 text-sm font-semibold transition-all duration-150 shadow-sm
                               <?php echo e($selectedCondition === $condKey
                                  ? $condColors[$condKey]['active'] . ' shadow-md'
                                  : $inactiveClass); ?>"
                        data-condition="<?php echo e($condKey); ?>">
                    <span class="text-base leading-none"><?php echo e($condDef['icon']); ?></span>
                    <span><?php echo e($condDef['label']); ?></span>
                </button>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 space-y-4 mt-5 mb-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" id="property_code" name="property_code" value="<?php echo e(old('property_code', $property->property_code ?? '')); ?>"
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                          ...
                          placeholder="Deskripsikan properti ini..." required><?php echo e(old('description', $property->description ?? '')); ?></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    ?>
                    <div class="flex">
                        <input type="text" id="price_value" name="price_value" value="<?php echo e($priceVal); ?>"
                        ...
                        <select name="price_unit" class="px-3 py-2.5 rounded-r-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent cursor-pointer font-medium">
                            <option value="Ribu" <?php echo e($priceUnit == 'Ribu' ? 'selected' : ''); ?>>Ribu</option>
                            <option value="Juta" <?php echo e($priceUnit == 'Juta' ? 'selected' : ''); ?>>Juta</option>
                            <option value="Miliar" <?php echo e($priceUnit == 'Miliar' ? 'selected' : ''); ?>>Miliar</option>
                            <option value="Triliun" <?php echo e($priceUnit == 'Triliun' ? 'selected' : ''); ?>>Triliun</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 space-y-4 mt-5 mb-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="province" name="province" value="<?php echo e(old('province', $property->province ?? '')); ?>"
            ...
            <div>
                ...
                <input type="text" id="district" name="district" value="<?php echo e(old('district', $property->district ?? '')); ?>"
                       class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="complex_name" name="complex_name" value="<?php echo e(old('complex_name', $property->complex_name ?? '')); ?>"
                           class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="street_name" name="street_name" value="<?php echo e(old('street_name', $property->street_name ?? '')); ?>"
                               class="w-full pl-10 px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 space-y-4 mt-5 mb-5">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4" id="spec-counter-grid" x-show="propertyType !== 'tanah' && propertyType !== 'ruang-usaha'">
                <div data-spec="bedrooms" x-show="!['tanah','gudang','pabrik','ruko','hotel','perkantoran','ruang-usaha'].includes(propertyType)">
                    ...
                    <div class="flex items-center justify-between border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <input type="number" id="bedrooms" name="bedrooms" value="<?php echo e(old('bedrooms', $property->bedrooms ?? 0)); ?>"
                ...
                <div data-spec="bathrooms" x-show="!['tanah','gudang','pabrik','ruko','hotel','perkantoran','ruang-usaha'].includes(propertyType)">
                    ...
                    <div class="flex items-center justify-between border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <input type="number" id="bathrooms" name="bathrooms" value="<?php echo e(old('bathrooms', $property->bathrooms ?? 0)); ?>"
                               class="w-full text-center py-2.5 text-sm font-semibold text-gray-900 dark:text-white bg-white dark:bg-gray-800 border-x border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-0 pointer-events-none [-moz-appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                               min="0" readonly>
                ...
                <div data-spec="floors" x-show="!['tanah'].includes(propertyType)">
                    ...
                    <div class="flex items-center justify-between border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <input type="number" id="floors" name="floors" value="<?php echo e(old('floors', $property->floors ?? 1)); ?>"
                               class="w-full text-center py-2.5 text-sm font-semibold text-gray-900 dark:text-white bg-white dark:bg-gray-800 border-x border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-0 pointer-events-none [-moz-appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                               min="1" readonly>
                ...
                <div data-spec="garages" x-show="!['apartemen','tanah','hotel','perkantoran','ruang-usaha','kost'].includes(propertyType)">
                    ...
                    <div class="flex items-center justify-between border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <input type="number" id="garages" name="garages" value="<?php echo e(old('garages', $property->garages ?? 0)); ?>"
                               class="w-full text-center py-2.5 text-sm font-semibold text-gray-900 dark:text-white bg-white dark:bg-gray-800 border-x border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-0 pointer-events-none [-moz-appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                               min="0" readonly>
                ...
                <div data-spec="carports" x-show="!['apartemen','tanah','ruko','gudang','pabrik','hotel','perkantoran','ruang-usaha','kost'].includes(propertyType)">
                    ...
                    <div class="flex items-center justify-between border border-gray-300 dark:border-gray-700 rounded-lg overflow-hidden">
                        ...
                        <input type="number" id="carports" name="carports" value="<?php echo e(old('carports', $property->carports ?? 0)); ?>"
                               class="w-full text-center py-2.5 text-sm font-semibold text-gray-900 dark:text-white bg-white dark:bg-gray-800 border-x border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-0 pointer-events-none [-moz-appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                               min="0" readonly>
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div data-spec="land_area" x-show="propertyType !== 'apartemen'">
                    ...
                    <input type="number" id="land_area" name="land_area" value="<?php echo e(old('land_area', $property->land_area ?? 0)); ?>"
                           class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                           min="" placeholder="120">
                </div>
                <div data-spec="build_area" x-show="propertyType !== 'tanah'">
                    ...
                    <input type="number" id="build_area" name="build_area" value="<?php echo e(old('build_area', $property->build_area ?? 0)); ?>"
                           class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                           min="" placeholder="90">
                </div>
                ...
                <div x-show="propertyType === 'tanah'" style="display: none;">
                    ...
                    <input type="number" id="land_length" name="land_length" value="<?php echo e(old('land_length', $property->land_length ?? 0)); ?>"
                           class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                           min="0" placeholder="0">
                </div>
                <div x-show="propertyType === 'tanah'" style="display: none;">
                    <label for="land_width" class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">Lebar Tanah (m)</label>
                    <input type="number" id="land_width" name="land_width" value="<?php echo e(old('land_width', $property->land_width ?? 0)); ?>"
                           class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                           min="0" placeholder="0">
                </div>
                ...
                <div x-show="propertyType === 'apartemen'" style="display: none;">
                    ...
                    <input type="text" id="floor_number" name="floor_number" value="<?php echo e(old('floor_number', $property->floor_number ?? '')); ?>"
                           class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                           placeholder="Contoh: 12A">
                </div>
                <div x-show="propertyType === 'apartemen'" style="display: none;" class="flex items-center gap-6 mt-6">
                    <label class="flex items-center gap-2 cursor-pointer group">
                        <input type="checkbox" name="is_studio" value="1" class="w-4 h-4 rounded border-gray-300 text-amber-500 focus:ring-amber-500" <?php echo e(old('is_studio', $property->is_studio ?? false) ? 'checked' : ''); ?>>
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Tipe Studio</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer group">
                        <input type="checkbox" name="is_mezzanine" value="1" class="w-4 h-4 rounded border-gray-300 text-amber-500 focus:ring-amber-500" <?php echo e(old('is_mezzanine', $property->is_mezzanine ?? false) ? 'checked' : ''); ?>>
            ...
            <div x-show="showDetails" x-collapse style="display: none;" class="p-5 pt-0 border-t border-gray-100 dark:border-gray-800 mt-2">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <template x-for="cert in ['SHM', 'HGB', 'Strata Title', 'Lainnya']">
                                <label class="cursor-pointer">
                                    <input type="radio" name="certificate" :value="cert" class="peer sr-only" :checked="'<?php echo e(old('certificate', $property->certificate ?? '')); ?>' === cert">
                    ...
                    <div>
                        ...
                        <input type="number" name="build_year" value="<?php echo e(old('build_year', $property->build_year ?? '')); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" name="electricity" value="<?php echo e(old('electricity', $property->electricity ?? '')); ?>"
                               class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <select name="orientation" class="w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500">
                            ...
                            <option value="Utara" <?php echo e(old('orientation', $property->orientation ?? '') == 'Utara' ? 'selected' : ''); ?>>Utara</option>
                            <option value="Timur" <?php echo e(old('orientation', $property->orientation ?? '') == 'Timur' ? 'selected' : ''); ?>>Timur</option>
                            <option value="Selatan" <?php echo e(old('orientation', $property->orientation ?? '') == 'Selatan' ? 'selected' : ''); ?>>Selatan</option>
                            <option value="Barat" <?php echo e(old('orientation', $property->orientation ?? '') == 'Barat' ? 'selected' : ''); ?>>Barat</option>
                        </select>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 space-y-4 mt-5 mb-5">
            ...
            <div>
                ...
                <select name="category_id" class="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent" required>
                    <option value="" disabled <?php echo e(!isset($property) && !old('category_id') ? 'selected' : ''); ?>>-- Pilih Kategori --</option>
                    <?php $__currentLoopData = $parentCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <optgroup label="<?php echo e($category->name); ?>" class="font-bold text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-800">
                            <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($child->id); ?>" class="font-normal text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900" <?php echo e((isset($property) && $property->categories->contains($child->id)) || old('category_id') == $child->id ? 'selected' : ''); ?>>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 space-y-4 mt-5 mb-5">
            ...
            <?php if(isset($property) && $property->photos->count() > 0): ?>
            <div>
                <div class="flex items-center justify-between mb-3">
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        <span class="font-semibold text-gray-700 dark:text-gray-200"><?php echo e($property->photos->count()); ?> foto</span>
                            ...
                            <div class="relative" x-data="false">
                                ...
                                <div class="photo-menu-dropdown hidden absolute right-0 top-8 z-20 w-32 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1">
                                    <button type="button"
                                            ...
                                            data-photo-id="<?php echo e($photo->id); ?>"
                                            data-delete-url="<?php echo e(route('admin.properties.photos.destroy', [$property, $photo])); ?>">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 mt-5 mb-5">
            ...
            <label class="flex items-center gap-3 cursor-pointer group">
                <input type="checkbox" name="is_featured" value="1"
                       ...
                       <?php echo e(old('is_featured', isset($property) ? $property->is_featured : false) ? 'checked' : ''); ?>>
                <div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (existingGrid) {
        ...
        function saveOrderAjax () {
            ...
            fetch('<?php echo e(route("admin.properties.photos.reorder", $property ?? 0)); ?>', {
                method : 'POST',
    ...
    const isEdit = <?php echo e(isset($property) ? 'true' : 'false'); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u851258633/domains/bintarolandproperty.com/public_html/resources/views/admin/properties/form.blade.php ENDPATH**/ ?>