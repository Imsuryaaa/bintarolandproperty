...
<section class="py-12 lg:py-16 bg-gray-50 dark:bg-charcoal-900/50">
    <div class="container-main">
        <div class="flex items-end justify-between mb-7">
            ...
            <a href="<?php echo e(route('home')); ?>#properties" class="text-sm text-brand-600 dark:text-brand-400 hover:underline font-medium hidden sm:block">
                Lihat semua →
            </a>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Gawe\website landing page\bintaro-property\resources\views/home.blade.php ENDPATH**/ ?>