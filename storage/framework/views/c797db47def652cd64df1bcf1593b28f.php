...
<?php $__env->startSection('page-title', 'Promo & Hot Sale'); ?>
...
<div class="flex flex-col lg:flex-row gap-6">
    ...
    <div class="w-full lg:w-1/3">
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 sticky top-24">
            ...
            <form action="<?php echo e(route('admin.promos.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                <?php echo csrf_field(); ?>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                            <td class="px-5 py-3.5">
                                <?php if($promo->image_path): ?>
                                    <img src="<?php echo e(Storage::url($promo->image_path)); ?>" alt="<?php echo e($promo->title); ?>" class="w-12 h-12 rounded object-cover border border-gray-200 dark:border-gray-700">
                                <?php else: ?>
                            ...
                            <td class="px-5 py-3.5">
                                <p class="font-bold text-gray-900 dark:text-white mb-0.5"><?php echo e($promo->title); ?></p>
                                <?php if($promo->description): ?>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 line-clamp-1"><?php echo e($promo->description); ?></p>
                                <?php endif; ?>
                                <p class="text-[10px] text-gray-400 mt-1 flex flex-col gap-0.5">
                                    <span>Dibuat: <?php echo e($promo->created_at->format('d M Y')); ?></span>
                                    <?php if($promo->start_date || $promo->end_date): ?>
                                        <span class="text-amber-600 dark:text-amber-400 font-medium">Jadwal: <?php echo e($promo->start_date ? $promo->start_date->format('d M Y H:i') : 'Sekarang'); ?> - <?php echo e($promo->end_date ? $promo->end_date->format('d M Y H:i') : 'Seterusnya'); ?></span>
                                    <?php endif; ?>
                                </p>
                            </td>
                            <td class="px-5 py-3.5 text-center">
                                <form action="<?php echo e(route('admin.promos.toggle-status', $promo)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="inline-flex px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider transition-colors <?php echo e($promo->is_active ? 'bg-green-100 text-green-700 hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-400'); ?>">
                            ...
                            <td class="px-5 py-3.5 text-right">
                                <form action="<?php echo e(route('admin.promos.destroy', $promo)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus promo ini?');">
                                    <?php echo csrf_field(); ?>
            ...
            <?php if($promos->hasPages()): ?>
                <div class="px-5 py-3 border-t border-gray-100 dark:border-gray-800">
                    <?php echo e($promos->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u851258633/domains/bintarolandproperty.com/public_html/resources/views/admin/promos/index.blade.php ENDPATH**/ ?>