<header id="main-navbar" data-aos="fade-down"
    ...
    <div id="mobile-nav"
        ...
        <div class="container-main py-3 space-y-0.5">
            <a href="<?php echo e(route('home')); ?>"
               class="block px-3 py-2.5 text-sm font-medium rounded-md <?php echo e(request()->routeIs('home') ? 'text-brand-600 bg-brand-50 dark:bg-brand-900/20' : 'text-gray-700 dark:text-charcoal-200 hover:bg-gray-50 dark:hover:bg-charcoal-800'); ?> transition-colors duration-150">
                Beranda
            </a>
            <a href="<?php echo e(route('home')); ?>#properties"
            ...
            <div class="space-y-0.5">
                ...
                <div id="submenu-primary" class="hidden pl-4 pr-2 pb-2 space-y-0.5 border-l border-gray-100 dark:border-charcoal-800 ml-3">
                    <a href="<?php echo e(route('category.show', 'dharmawangsa-home')); ?>"        class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Dharmawangsa Home</a>
                    <a href="<?php echo e(route('category.show', 'nivara-dharmawangsa')); ?>"      class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Nivara – Dharmawangsa</a>
                    <a href="<?php echo e(route('category.show', 'naraya-dharmawangsa')); ?>"      class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Naraya – Dharmawangsa</a>
                    <a href="<?php echo e(route('category.show', 'nordic-kebayoran-harmony')); ?>" class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Nordic – Kebayoran Harmony</a>
                    <a href="<?php echo e(route('category.show', 'navia-kebayoran-piazza')); ?>"   class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Navia – Kebayoran Piazza</a>
                    <a href="<?php echo e(route('category.show', 'chiara-kebayoran-village')); ?>" class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Chiara – Kebayoran Village</a>
                    <a href="<?php echo e(route('category.show', 'discovery-altezza')); ?>"        class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Discovery Altezza</a>
                    <a href="<?php echo e(route('category.show', 'discovery-azzura')); ?>"         class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Discovery Azzura</a>
                    <a href="<?php echo e(route('category.show', 'maika-discovery-aluvia')); ?>"   class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Maika – Discovery Aluvia</a>
                    <a href="<?php echo e(route('category.show', 'vista-discovery-aluvia')); ?>"   class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Vista – Discovery Aluvia</a>
                    <a href="<?php echo e(route('category.show', '9-home')); ?>"                   class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">9 Home</a>
                    <a href="<?php echo e(route('category.show', 'montana')); ?>"                  class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Montana</a>
                    <a href="<?php echo e(route('category.show', 'aira-discovery-riviera')); ?>"   class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Aira – Discovery Riviera</a>
                    <a href="<?php echo e(route('category.show', 'bria-discovery-riviera')); ?>"   class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Bria – Discovery Riviera</a>
                    <a href="<?php echo e(route('category.show', 'botanica-arallia')); ?>"         class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Botanica Arallia</a>
                    <a href="<?php echo e(route('category.show', 'botanica-bellisa')); ?>"         class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Botanica Bellisa</a>
                    <a href="<?php echo e(route('category.show', 'wichita-bukit-menteng')); ?>"    class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Wichita – Bukit Menteng</a>
                    <a href="<?php echo e(route('category.show', 'ruko-emerald-core')); ?>"        class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Ruko Emerald Core</a>
                    <a href="<?php echo e(route('category.show', 'ruko-botanica-avenue-2')); ?>"   class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Ruko Botanica Avenue 2</a>
                    <a href="<?php echo e(route('category.show', 'ruko-kebayoran-square')); ?>"    class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Ruko Kebayoran Square</a>
                    <a href="<?php echo e(route('category.show', 'ruko-u-town-house')); ?>"        class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Ruko U Town House</a>
                    <a href="<?php echo e(route('category.show', 'kavling')); ?>"                  class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Kavling</a>
                </div>
            </div>
            ...
            <div class="space-y-0.5">
                ...
                <div id="submenu-secondary" class="hidden pl-4 pr-2 pb-2 space-y-0.5 border-l border-gray-100 dark:border-charcoal-800 ml-3">
                    <a href="<?php echo e(route('category.show', 'menteng')); ?>"             class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Menteng</a>
                    <a href="<?php echo e(route('category.show', 'kebayoran-residence')); ?>" class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Kebayoran Residence</a>
                    <a href="<?php echo e(route('category.show', 'discovery')); ?>"           class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Discovery</a>
                    <a href="<?php echo e(route('category.show', 'emerald')); ?>"             class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Emerald</a>
                    <a href="<?php echo e(route('category.show', 'botanica')); ?>"            class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Botanica</a>
                    <a href="<?php echo e(route('category.show', 'graha-taman')); ?>"         class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Graha Taman</a>
                    <a href="<?php echo e(route('category.show', 'puri-bintaro')); ?>"        class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Puri Bintaro</a>
                    <a href="<?php echo e(route('category.show', 'graha-raya')); ?>"          class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Graha Raya</a>
                    <a href="<?php echo e(route('category.show', 'sektor-1-2')); ?>"          class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Sektor 1–2</a>
                    <a href="<?php echo e(route('category.show', 'sektor-3-4')); ?>"          class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Sektor 3–4</a>
                    <a href="<?php echo e(route('category.show', 'sektor-5-6')); ?>"          class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Sektor 5–6</a>
                    <a href="<?php echo e(route('category.show', 'sektor-8')); ?>"            class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Sektor 8</a>
                    <a href="<?php echo e(route('category.show', 'sektor-9')); ?>"            class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Sektor 9</a>
                </div>
            </div>
            ...
            <div class="space-y-0.5">
                ...
                <div id="submenu-luar" class="hidden pl-4 space-y-0.5 border-l border-gray-100 dark:border-charcoal-800 ml-3">
                    <a href="<?php echo e(route('category.show', 'pondok-aren')); ?>"      class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Pondok Aren</a>
                    <a href="<?php echo e(route('category.show', 'ciputat-pamulang')); ?>" class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Ciputat &amp; Pamulang</a>
                    <a href="<?php echo e(route('category.show', 'jakarta-selatan')); ?>"  class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Jakarta Selatan</a>
                    <a href="<?php echo e(route('category.show', 'serpong-bsd')); ?>"      class="block px-3 py-2 text-xs text-gray-600 dark:text-charcoal-300 hover:bg-gray-50 dark:hover:bg-charcoal-800 rounded-md">Serpong &amp; BSD</a>
                </div>
            </div>

            <a href="<?php echo e(route('simulasi-kpr')); ?>"
               class="block px-3 py-2.5 text-sm font-medium rounded-md <?php echo e(request()->routeIs('simulasi-kpr') ? 'text-brand-600 bg-brand-50 dark:bg-brand-900/20' : 'text-gray-700 dark:text-charcoal-200 hover:bg-gray-50 dark:hover:bg-charcoal-800'); ?> transition-colors duration-150">
                Simulasi KPR
            </a>
            <a href="<?php echo e(route('home')); ?>#kontak"
               class="block px-3 py-2.5 text-sm font-medium rounded-md text-gray-700 dark:text-charcoal-200 hover:bg-gray-50 dark:hover:bg-charcoal-800 transition-colors duration-150">
...
<?php /**PATH /home/u851258633/domains/bintarolandproperty.com/public_html/resources/views/partials/navbar.blade.php ENDPATH**/ ?>