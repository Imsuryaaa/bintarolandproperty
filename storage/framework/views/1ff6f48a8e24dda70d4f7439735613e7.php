        ...
        <table class="w-full text-sm min-w-[600px]">
            ...
            <tbody id="ctBody" class="divide-y divide-gray-100 dark:divide-gray-800">
                ...
                <tr class="ct-row hover:bg-amber-50/40 dark:hover:bg-amber-900/10 transition-colors duration-150"
                    data-search="<?php echo e(strtolower($property->title . ' ' . $property->full_location . ' ' . $property->formatted_price)); ?>">
                    ...
                    <td class="px-5 py-3.5 whitespace-nowrap text-gray-700 dark:text-gray-300 font-semibold"><?php echo e($property->formatted_price); ?></td>
                    <td class="px-5 py-3.5 text-gray-500 dark:text-gray-400 text-sm">
                        <span class="block truncate max-w-[200px]"><?php echo e($property->full_location); ?></span>
                    </td>
