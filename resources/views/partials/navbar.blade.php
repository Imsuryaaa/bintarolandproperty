...
<nav class="xl:hidden fixed bottom-0 left-0 w-full z-50 bg-white dark:bg-charcoal-950 border-t border-gray-200 dark:border-charcoal-800 pb-safe shadow-[0_-4px_10px_-1px_rgba(0,0,0,0.1)]">
    <div class="flex w-full py-2">
        <a href="{{ route('home') }}" class="flex-1 flex flex-col items-center justify-center gap-1 {{ request()->routeIs('home') ? 'text-brand-600 dark:text-brand-400' : 'text-gray-500 dark:text-charcoal-400' }}">
        ...
        <a href="{{ route('simulasi-kpr') }}" class="flex-1 flex flex-col items-center justify-center gap-1 {{ request()->routeIs('simulasi-kpr') ? 'text-brand-600 dark:text-brand-400' : 'text-gray-500 dark:text-charcoal-400' }}">
        ...
        <a href="https://wa.me/{{ env('WHATSAPP_NUMBER', '6281234567890') }}" target="_blank" rel="noopener noreferrer" class="flex-1 flex flex-col items-center justify-center gap-1 text-gray-500 dark:text-charcoal-400">
                ...
                <div id="submenu-primary" class="grid transition-all duration-300 ease-in-out" style="grid-template-rows: 0fr;">
                    <div class="overflow-hidden">
                        <div class="px-4 pb-4 space-y-1 bg-white dark:bg-charcoal-900 border-t border-gray-100 dark:border-charcoal-800">
                            <div class="pt-2"></div>
                            <a href="{{ route('category.show', 'dharmawangsa-home') }}"        class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Dharmawangsa Home</a>
                            <a href="{{ route('category.show', 'nivara-dharmawangsa') }}"      class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Nivara – Dharmawangsa</a>
                            <a href="{{ route('category.show', 'naraya-dharmawangsa') }}"      class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Naraya – Dharmawangsa</a>
                            <a href="{{ route('category.show', 'nordic-kebayoran-harmony') }}" class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Nordic – Kebayoran Harmony</a>
                            <a href="{{ route('category.show', 'navia-kebayoran-piazza') }}"   class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Navia – Kebayoran Piazza</a>
                            <a href="{{ route('category.show', 'chiara-kebayoran-village') }}" class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Chiara – Kebayoran Village</a>
                            <a href="{{ route('category.show', 'discovery-altezza') }}"        class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Discovery Altezza</a>
                            <a href="{{ route('category.show', 'discovery-azzura') }}"         class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Discovery Azzura</a>
                            <a href="{{ route('category.show', 'maika-discovery-aluvia') }}"   class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Maika – Discovery Aluvia</a>
                            <a href="{{ route('category.show', 'vista-discovery-aluvia') }}"   class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Vista – Discovery Aluvia</a>
                            <a href="{{ route('category.show', '9-home') }}"                   class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">9 Home</a>
                            <a href="{{ route('category.show', 'montana') }}"                  class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Montana</a>
                            <a href="{{ route('category.show', 'aira-discovery-riviera') }}"   class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Aira – Discovery Riviera</a>
                            <a href="{{ route('category.show', 'bria-discovery-riviera') }}"   class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Bria – Discovery Riviera</a>
                            <a href="{{ route('category.show', 'botanica-arallia') }}"         class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Botanica Arallia</a>
                            <a href="{{ route('category.show', 'botanica-bellisa') }}"         class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Botanica Bellisa</a>
                            <a href="{{ route('category.show', 'wichita-bukit-menteng') }}"    class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Wichita – Bukit Menteng</a>
                            <a href="{{ route('category.show', 'ruko-emerald-core') }}"        class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Ruko Emerald Core</a>
                            <a href="{{ route('category.show', 'ruko-botanica-avenue-2') }}"   class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Ruko Botanica Avenue 2</a>
                            <a href="{{ route('category.show', 'ruko-kebayoran-square') }}"    class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Ruko Kebayoran Square</a>
                            <a href="{{ route('category.show', 'ruko-u-town-house') }}"        class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Ruko U Town House</a>
                            <a href="{{ route('category.show', 'kavling') }}"                  class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Kavling</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-charcoal-900 rounded-xl overflow-hidden">
                ...
                <div id="submenu-secondary" class="grid transition-all duration-300 ease-in-out" style="grid-template-rows: 0fr;">
                    <div class="overflow-hidden">
                        <div class="px-4 pb-4 space-y-1 bg-white dark:bg-charcoal-900 border-t border-gray-100 dark:border-charcoal-800">
                            <div class="pt-2"></div>
                            <a href="{{ route('category.show', 'menteng') }}"             class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Menteng</a>
                            <a href="{{ route('category.show', 'kebayoran-residence') }}" class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Kebayoran Residence</a>
                            <a href="{{ route('category.show', 'discovery') }}"           class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Discovery</a>
                            <a href="{{ route('category.show', 'emerald') }}"             class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Emerald</a>
                            <a href="{{ route('category.show', 'botanica') }}"            class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Botanica</a>
                            <a href="{{ route('category.show', 'graha-taman') }}"         class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Graha Taman</a>
                            <a href="{{ route('category.show', 'puri-bintaro') }}"        class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Puri Bintaro</a>
                            <a href="{{ route('category.show', 'graha-raya') }}"          class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Graha Raya</a>
                            <a href="{{ route('category.show', 'sektor-1-2') }}"          class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Sektor 1–2</a>
                            <a href="{{ route('category.show', 'sektor-3-4') }}"          class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Sektor 3–4</a>
                            <a href="{{ route('category.show', 'sektor-5-6') }}"          class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Sektor 5–6</a>
                            <a href="{{ route('category.show', 'sektor-8') }}"            class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Sektor 8</a>
                            <a href="{{ route('category.show', 'sektor-9') }}"            class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Sektor 9</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-charcoal-900 rounded-xl overflow-hidden">
                ...
                <div id="submenu-luar" class="grid transition-all duration-300 ease-in-out" style="grid-template-rows: 0fr;">
                    <div class="overflow-hidden">
                        <div class="px-4 pb-4 space-y-1 bg-white dark:bg-charcoal-900 border-t border-gray-100 dark:border-charcoal-800">
                            <div class="pt-2"></div>
                            <a href="{{ route('category.show', 'pondok-aren') }}"      class="block py-2.5 text-sm text-gray-600 dark:text-charcoal-300 hover:text-brand-600 dark:hover:text-brand-400">Pondok Aren</a>
