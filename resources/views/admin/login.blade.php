...
<body class="min-h-screen bg-gray-100 dark:bg-gray-950 flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-sm">
        ...
        <div class="flex flex-col items-center mb-8">
            <img src="{{ asset('images/logo.jpg') }}" alt="Bintaro Land Property" class="h-20 w-auto rounded-xl mb-4">
            ...
            <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        autofocus
                        class="w-full px-3.5 py-2.5 rounded-lg border {{ $errors->has('username') ? 'border-red-400 dark:border-red-600' : 'border-gray-300 dark:border-gray-700' }} bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition"
                        placeholder="admin"
                    >
                    @error('username')
                ...
                <div>
                    ...
                    <div class="relative">
                        <input
                            ...
                            class="w-full px-3.5 py-2.5 rounded-lg border {{ $errors->has('password') ? 'border-red-400 dark:border-red-600' : 'border-gray-300 dark:border-gray-700' }} bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition pr-10"
                            placeholder="••••••••"
                        >
        ...
        <div class="text-center mt-5">
            <a href="{{ route('home') }}" class="text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                ← Kembali ke website
            </a>
        </div>
    </div>
