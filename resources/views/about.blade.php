...
<section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex items-center justify-center min-h-[40vh]">
    <div class="absolute inset-0">
        <img src="{{ asset('unsplash_image/Halaman_Tentang_Kami/TentangBintaroLandProperty.jpg') }}" alt="Tentang Bintaro Land Property" width="1920" height="1080" fetchpriority="high" loading="eager" class="w-full h-full object-cover">
...
<section class="py-16 lg:py-24 bg-white dark:bg-charcoal-950">
    <div class="container-main">
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
            <div class="relative" data-aos="fade-right">
                <div class="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                    <img src="{{ asset('unsplash_image/Halaman_Tentang_Kami/TimBintaroLandProperty.jpg') }}" alt="Tim Bintaro Land Property" width="800" height="600" loading="lazy" class="w-full h-full object-cover">
                </div>
                <!-- Decorative element -->
        ...
        <div class="relative rounded-3xl overflow-hidden bg-brand-600 mb-24 shadow-xl" data-aos="zoom-in">
            <div class="absolute inset-0">
                <img src="{{ asset('unsplash_image/Halaman_Tentang_Kami/InteriorMewah.jpg') }}" alt="Interior Mewah" width="1200" height="600" loading="lazy" class="w-full h-full object-cover mix-blend-overlay opacity-40">
