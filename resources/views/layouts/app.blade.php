...
<head>
    ...
    <link rel="preload" as="image"
          href="{{ asset('unsplash_image/HalamanHome/Properti_Bintaro.webp') }}"
          type="image/webp"
          fetchpriority="high">
...
<body class="min-h-screen pb-16 xl:pb-0 overflow-x-hidden w-full">
    ...
    <a href="https://wa.me/{{ env('WHATSAPP_NUMBER', '6281234567890') }}?text={{ urlencode('Halo Bintaro Land Property, saya ingin informasi properti.') }}"
       target="_blank" rel="noopener noreferrer"
       class="hidden xl:flex fixed bottom-6 right-5 z-50 items-center gap-2 px-4 py-3 bg-[#25D366] hover:bg-[#1ebe5d] text-white text-sm font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group"
