...
<body class="min-h-screen">
    ...
    <a href="https://wa.me/{{ env('WHATSAPP_NUMBER', '6281234567890') }}?text={{ urlencode('Halo Bintaro Land Property, saya ingin informasi properti.') }}"
       ...
       class="fixed bottom-6 right-5 z-50 flex items-center gap-2 px-4 py-3 bg-[#25D366] hover:bg-[#1ebe5d] text-white text-sm font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-200 group"
